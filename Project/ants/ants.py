...
# END Problem 12
    ...
    def action(self, gamestate):
        ...
        while place:
            ant = place.ant
            if ant: 
                if not hasattr(ant, 'buffed'):
                    ant.buffed = True
                    ant.damage *= 2
                if ant.is_container and ant.ant_contained:
                    if not hasattr(ant.ant_contained, 'buffed'):
                        ant.ant_contained.damage *= 2
                        ant.ant_contained.buffed = True
            place = place.exit
        # END Problem 12
...
class LaserAnt(ThrowerAnt):
    ...
    def calculate_damage(self, distance):
        # BEGIN Problem Optional 2
        damage = (self.damage - 0.25*distance) - (1/16)*self.insects_shot 
        return damage
        # 1.1875 dis = 3
        # END Problem Optional 2
    ...
    def action(self, gamestate):
        ...
        for insect, distance in insects_and_distances.items():
            ...
            # print("DEBUG:", insect, distance, damage)
