...
class Player:
    def __init__(self, deck, name):
        ...
        self.hand = []
        for _ in range(5):
            self.hand.append(Deck.draw(deck))
    ...
    def draw(self):
        ...
        self.hand.append(Deck.draw(self.deck))
...
class InstructorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        for eachcard in player.deck.cards:
            eachcard.attack += opponent_card.attack
            eachcard.defense += opponent_card.defense
        cpy = list(opponent.deck.cards)
        for eachcard in cpy:
            if eachcard.attack == opponent_card.attack or eachcard.defense == opponent_card.defense:
                opponent.deck.cards.remove(eachcard)
        # You should add your implementation above this.
